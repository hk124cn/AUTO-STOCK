const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/loader-wwKUpaDD.js","assets/index-dXDZ0nX5.js","assets/index-Bvo5RvaK.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, k as watch, o as onMounted, l as onUnmounted, a as openBlock, c as createElementBlock, b as createBaseVNode, n as normalizeClass, i as createCommentVNode, t as toDisplayString, u as unref, d as createTextVNode, F as Fragment, f as renderList, m as withModifiers, h as withDirectives, v as vModelText, r as ref, p as reactive, q as authedFetch, j as computed, s as __vitePreload } from "./index-dXDZ0nX5.js";
import { s as smartFetch, f as formatMoney, e as getChangeClass, h as formatPercent, i as loadPositions, j as loadTrades, k as loadStats, m as getCacheTTL, n as getMarketState, b as gotoYujing, d as formatNumber } from "./loader-wwKUpaDD.js";
      ...
      try {
        ...
        if (data.success) {
          ...
          const { clearAllCache } = await __vitePreload(async () => {
            const { clearAllCache: clearAllCache2 } = await import("./loader-wwKUpaDD.js").then((n) => n.q);
