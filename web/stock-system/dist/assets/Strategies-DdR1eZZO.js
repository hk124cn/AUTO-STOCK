import { _ as _export_sfc, o as onMounted, a as openBlock, c as createElementBlock, b as createBaseVNode, h as withDirectives, y as vModelSelect, F as Fragment, r as renderList, t as toDisplayString, m as withModifiers, v as vModelText, z as vModelCheckbox, e as createTextVNode, i as createCommentVNode, p as reactive, q as authedFetch, f as ref, j as computed, n as normalizeClass, u as unref } from "./index-CBDHGmro.js";
import { c as clearAllCache, b as getChangeClass, d as formatPercent } from "./loader-iyL5bcsQ.js";
const _hoisted_1 = { class: "strategies-page" };
const _hoisted_2 = { class: "card" };
const _hoisted_3 = { class: "binding-grid" };
const _hoisted_4 = { class: "binding-item" };
const _hoisted_5 = ["value"];
const _hoisted_6 = { class: "binding-item" };
...
const _hoisted_12 = { class: "up" };
const _hoisted_13 = { class: "down" };
...
const _hoisted_32 = { class: "form-row" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[36] || (_cache[36] = createBaseVNode("h1", { class: "page-title" }, "⚙️ 策略管理", -1)),
        createBaseVNode("div", _hoisted_2, [
          ...
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              _cache[14] || (_cache[14] = createBaseVNode("div", { class: "binding-label" }, "🎲 模拟仓策略", -1)),
              withDirectives(createBaseVNode("select", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(strategies.value, (s) => {
                  return openBlock(), createElementBlock("option", {
                    key: `sim-${s.id}`,
                    value: s.id
                  }, toDisplayString(s.name) + "（买入≥" + toDisplayString(s.buy_threshold) + ", 止盈" + toDisplayString(s.take_profit * 100) + "%, 止损" + toDisplayString(s.stop_loss * 100) + "%） ", 9, _hoisted_5);
                }), 128))
              ], 544), [
            ...
            createBaseVNode("div", _hoisted_6, [
              _cache[15] || (_cache[15] = createBaseVNode("div", { class: "binding-label" }, "💰 实盘策略", -1)),
              withDirectives(createBaseVNode("select", {
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(strategies.value, (s) => {
                  return openBlock(), createElementBlock("option", {
                    key: `real-${s.id}`,
                    value: s.id
                  }, toDisplayString(s.name) + "（买入≥" + toDisplayString(s.buy_threshold) + ", 止盈" + toDisplayString(s.take_profit * 100) + "%, 止损" + toDisplayString(s.stop_loss * 100) + "%） ", 9, _hoisted_7);
                }), 128))
              ], 544), [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(strategies.value, (s) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", null, [
                    ...
                    s.is_default ? (openBlock(), createElementBlock("span", _hoisted_11, "默认")) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("td", null, "≥ " + toDisplayString(s.buy_threshold), 1),
                  createBaseVNode("td", _hoisted_12, "+" + toDisplayString((s.take_profit * 100).toFixed(0)) + "%", 1),
                  createBaseVNode("td", _hoisted_13, "-" + toDisplayString((s.stop_loss * 100).toFixed(0)) + "%", 1),
                  ...
                  createBaseVNode("td", _hoisted_14, toDisplayString(s.description || "-"), 1),
                  createBaseVNode("td", null, [
                    createBaseVNode("button", {
        ...
        createBaseVNode("div", _hoisted_18, [
          ...
          loadingBacktest.value ? (openBlock(), createElementBlock("div", _hoisted_19, "加载中...")) : backtestResults.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_20, "暂无回测结果")) : (openBlock(), createElementBlock("table", _hoisted_21, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(backtestResults.value, (b, idx) => {
                return openBlock(), createElementBlock("tr", {
                  ...
                  createBaseVNode("td", {
                    class: "name-cell",
                    title: b.readme_url
                  }, toDisplayString(b.name), 9, _hoisted_23),
                  ...
                  createBaseVNode("td", _hoisted_24, toDisplayString(unref(formatPercent)(-(b.max_drawdown || 0))), 1),
          ...
          createBaseVNode("div", _hoisted_25, [
            ...
            createBaseVNode("div", _hoisted_27, [
              createBaseVNode("div", _hoisted_28, [
                _cache[21] || (_cache[21] = createBaseVNode("label", null, "策略名称 *", -1)),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => editForm.name = $event),
                  placeholder: "如：稳健 / 激进 / 自定义"
                }, null, 512), [
              ...
              createBaseVNode("div", _hoisted_29, [
                createBaseVNode("div", _hoisted_30, [
                  _cache[22] || (_cache[22] = createBaseVNode("label", null, "买入阈值（前7日均分）", -1)),
                  withDirectives(createBaseVNode("input", {
                  ...
                  _cache[23] || (_cache[23] = createBaseVNode("div", { class: "form-hint" }, "≥ 此分才买入（默认 30）", -1))
                ]),
                createBaseVNode("div", _hoisted_31, [
                  _cache[24] || (_cache[24] = createBaseVNode("label", null, "止盈 %", -1)),
                  withDirectives(createBaseVNode("input", {
                  ...
                  _cache[25] || (_cache[25] = createBaseVNode("div", { class: "form-hint" }, "成本 × (1 + 此值) 为目标止盈价", -1))
                ])
              ]),
              createBaseVNode("div", _hoisted_32, [
                createBaseVNode("div", _hoisted_33, [
                  _cache[26] || (_cache[26] = createBaseVNode("label", null, "止损 %", -1)),
                  withDirectives(createBaseVNode("input", {
                  ...
                  _cache[27] || (_cache[27] = createBaseVNode("div", { class: "form-hint" }, "成本 × (1 - 此值) 为目标止损价", -1))
                ]),
                createBaseVNode("div", _hoisted_34, [
                  _cache[28] || (_cache[28] = createBaseVNode("label", null, "冷却天数", -1)),
                  withDirectives(createBaseVNode("input", {
                  ...
                  _cache[29] || (_cache[29] = createBaseVNode("div", { class: "form-hint" }, "同股两次信号间隔（默认 1）", -1))
                ])
              ]),
              createBaseVNode("div", _hoisted_35, [
                createBaseVNode("div", _hoisted_36, [
                  _cache[30] || (_cache[30] = createBaseVNode("label", null, "单股最大仓位 %", -1)),
                  withDirectives(createBaseVNode("input", {
                  ...
                  _cache[31] || (_cache[31] = createBaseVNode("div", { class: "form-hint" }, "占总资产比例（默认 0.20 = 20%）", -1))
                ]),
                createBaseVNode("div", _hoisted_37, [
                  _cache[32] || (_cache[32] = createBaseVNode("label", null, "最多持仓数", -1)),
                  withDirectives(createBaseVNode("input", {
                  ...
                  _cache[33] || (_cache[33] = createBaseVNode("div", { class: "form-hint" }, "同时持有股票数上限（默认 5）", -1))
                ])
              ]),
              createBaseVNode("div", _hoisted_38, [
                _cache[34] || (_cache[34] = createBaseVNode("label", null, "说明（可选）", -1)),
                withDirectives(createBaseVNode("input", {
              ...
              createBaseVNode("div", _hoisted_39, [
                createBaseVNode("label", null, [
                  ...
                  _cache[35] || (_cache[35] = createTextVNode(" 设为默认策略（账户创建时自动使用） ", -1))
                ])
              ]),
              editError.value ? (openBlock(), createElementBlock("div", _hoisted_40, "⚠️ " + toDisplayString(editError.value), 1)) : createCommentVNode("", true)
            ]),
            createBaseVNode("div", _hoisted_41, [
              ...
              createBaseVNode("button", {
                ...
                onClick: confirmEdit
              }, toDisplayString(submitting.value ? "保存中..." : "保存"), 9, _hoisted_42)
            ])
          ])
...
const Strategies = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-246ea1b2"]]);
export {
