const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Dashboard-CZZv5zKb.js","assets/loader-wwKUpaDD.js","assets/Dashboard-tIGKqqil.css","assets/Signals-EN4KVSCt.js","assets/Signals-cC97ngQC.css","assets/Portfolio-CGxTLeYj.js","assets/Portfolio-BcFNgU4x.css","assets/Stats-CtidAGIF.js","assets/Stats-BBuss3pn.css","assets/Strategies-Cpbgs-Sf.js","assets/Strategies-ujhLFISf.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
const _hoisted_1$1 = { class: "auth-modal" };
const _hoisted_2$1 = { class: "auth-body" };
const _hoisted_3$1 = ["disabled"];
const _hoisted_4$1 = {
  key: 0,
  class: "auth-error"
};
const _hoisted_5 = { class: "auth-footer" };
    ...
    return (_ctx, _cache) => {
      return __props.visible ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$1, [
          createBaseVNode("div", { class: "auth-header" }, [
            _cache[1] || (_cache[1] = createBaseVNode("h3", null, "🔒 实操密码", -1)),
          ...
          createBaseVNode("div", _hoisted_2$1, [
            _cache[2] || (_cache[2] = createBaseVNode("p", { class: "auth-hint" }, "请输入持仓/统计 实操密码以继续操作", -1)),
            ...
            __props.errorMsg ? (openBlock(), createElementBlock("div", _hoisted_4$1, "⚠️ " + toDisplayString(__props.errorMsg), 1)) : createCommentVNode("", true)
          ]),
          createBaseVNode("div", _hoisted_5, [
            ...
            createBaseVNode("button", {
              ...
              onClick: onSubmit,
              disabled: __props.submitting || !password.value
            }, toDisplayString(__props.submitting ? "验证中..." : "确认"), 9, _hoisted_7)
          ])
        ])
...
const PasswordModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-347ec492"]]);
const authModal = /* @__PURE__ */ reactive({
  visible: false,
  submitting: false,
  error: "",
  resolver: null
  // resolve(password-success) 或 reject(password-fail)
});
function showPasswordModal() {
  return new Promise((resolve2, reject) => {
    ...
    authModal.resolver = resolve2;
  });
}
function resolveAuthModal(success) {
...
function setToken(token, expiresIn) {
  ...
  localStorage.setItem(EXPIRES_KEY, String(Date.now() + expiresIn * 1e3));
}
function clearToken() {
...
function installRequestPassword(fn) {
  requestPassword = fn;
}
...
const _sfc_main = {
  __name: "App",
  setup(__props) {
    const authModal2 = inject("authModal");
    async function onPasswordSubmit(password) {
      if (!password) return;
      authModal2.submitting = true;
      authModal2.error = "";
      try {
        await login(password);
        authModal2.submitting = false;
        resolveAuthModal(true);
      } catch (e) {
        authModal2.submitting = false;
        authModal2.error = e.message || "登录失败";
      }
    }
    function onPasswordCancel() {
      if (authModal2.submitting) return;
      resolveAuthModal(false);
    }
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("nav", _hoisted_2, [
          _cache[5] || (_cache[5] = createBaseVNode("div", { class: "nav-brand" }, [
            createBaseVNode("span", { class: "brand-icon" }, "📈"),
            createBaseVNode("span", { class: "brand-text" }, "股票操作系统")
          ], -1)),
          createBaseVNode("div", _hoisted_3, [
            ...
            createVNode(_component_router_link, {
              ...
              default: withCtx(() => [..._cache[1] || (_cache[1] = [
                createBaseVNode("span", { class: "nav-icon" }, "📡", -1),
                createBaseVNode("span", null, "信号监控", -1)
              ])]),
              _: 1
            }),
            createVNode(_component_router_link, {
              ...
              default: withCtx(() => [..._cache[2] || (_cache[2] = [
                createBaseVNode("span", { class: "nav-icon" }, "💼", -1),
                createBaseVNode("span", null, "持仓管理", -1)
              ])]),
              _: 1
            }),
            createVNode(_component_router_link, {
              ...
              default: withCtx(() => [..._cache[3] || (_cache[3] = [
                createBaseVNode("span", { class: "nav-icon" }, "📊", -1),
                createBaseVNode("span", null, "收益统计", -1)
              ])]),
              _: 1
            }),
            createVNode(_component_router_link, {
              ...
              default: withCtx(() => [..._cache[4] || (_cache[4] = [
                ...
                createBaseVNode("span", null, "策略", -1)
              ])]),
              _: 1
            })
          ])
        ...
        createVNode(PasswordModal, {
          visible: unref(authModal2).visible,
          submitting: unref(authModal2).submitting,
          "error-msg": unref(authModal2).error,
          onSubmit: onPasswordSubmit,
          onCancel: onPasswordCancel
        }, null, 8, ["visible", "submitting", "error-msg"])
      ]);
    };
  }
};
const routes = [
  { path: "/", name: "Dashboard", component: () => __vitePreload(() => import("./Dashboard-CZZv5zKb.js"), true ? __vite__mapDeps([0,1,2]) : void 0) },
  { path: "/signals", name: "Signals", component: () => __vitePreload(() => import("./Signals-EN4KVSCt.js"), true ? __vite__mapDeps([3,1,4]) : void 0) },
  { path: "/portfolio", name: "Portfolio", component: () => __vitePreload(() => import("./Portfolio-CGxTLeYj.js"), true ? __vite__mapDeps([5,1,6]) : void 0) },
  { path: "/stats", name: "Stats", component: () => __vitePreload(() => import("./Stats-CtidAGIF.js"), true ? __vite__mapDeps([7,1,8]) : void 0) },
  { path: "/strategies", name: "Strategies", component: () => __vitePreload(() => import("./Strategies-Cpbgs-Sf.js"), true ? __vite__mapDeps([9,1,10]) : void 0) }
];
